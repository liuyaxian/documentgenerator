...
public class Test5283单只基金的交易记录 extends DocumentGeneratorServiceImpl {

    private static final  String bizcode = "5283";
    private static final  String bizcodeDesc = "单只基金的交易记录";
