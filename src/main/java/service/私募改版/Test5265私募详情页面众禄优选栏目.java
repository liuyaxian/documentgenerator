...
public class Test5265私募详情页面众禄优选栏目  extends DocumentGeneratorServiceImpl {

    private static final  String bizcode = "5265";
    private static final  String bizcodeDesc = "私募详情页面众禄优选栏目";
